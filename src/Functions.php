...
class Functions
{
    ...
    public function isBoolean($something){
    ...
    public function addItem($array){
        $result = array_push($array, "pastelito");
        return $result;
    }
    ...
    public function updateItem($array){
        $find_index = array_search("pastelito", $array);
        $array[$find_index] = "tarta";
        // if (in_array("pastelito", $array)){
        //     $solution = array_replace($array [])
        // };
        // return $solution;
    }
